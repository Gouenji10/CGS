        	...
        	<nav class="navbar fixed-top">         
                ...
                <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                    ...
                    <div class="navbar-header">
                        <a href="db-default.html" class="navbar-brand">
                            ...
                            <div class="brand-image brand-small">
                                <img src="<?php echo img('logo.png',true);?>" alt="logo" class="logo-small">
                            </div>
                        </a>
                        <!-- Toggle Button -->
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <ul aria-labelledby="notifications" class="dropdown-menu notification">
                                <li>
                                    <div class="notifications-header">
                                        ...
                                        <img src="<?php echo img('notifications/01.jpg',true);?>" alt="..." class="img-fluid">
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                        ...
                        <!-- End Notifications -->
                        <!-- User -->
                        <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="<?php echo img('avatar/avatar-01.jpg',true);?>" alt="..." class="avatar rounded-circle"></a>
                            <ul aria-labelledby="user" class="user-size dropdown-menu">
                                <li class="welcome">
                                    <a href="#" class="edit-profil"><i class="la la-gear"></i></a>
                                    <img src="<?php echo img('avatar/avatar-01.jpg',true);?>" alt="..." class="rounded-circle">
                                </li>
                                <li>
